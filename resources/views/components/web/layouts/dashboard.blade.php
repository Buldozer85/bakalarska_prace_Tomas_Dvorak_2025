...
<div class="flex w-full" x-data="{
                            ...
                            <li>
                                <ul role="list" class="-mx-2 space-y-1">
                                    <li>
                                        ...
                                        <a @click="currentUrl = '#'" class="bg-gray-50 text-indigo-600 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                                    ...
                                    <li>
                                        <a @click="currentUrl = '#'" class="text-gray-700 hover:text-indigo-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
        ...
        <div class="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
            <nav class="flex flex-1 flex-col">
                <ul role="list" class="flex flex-1 flex-col gap-y-7">
                    <li>
                        <ul role="list" class="-mx-2 space-y-1">
                            <x-web::dashboard-menu-component hash="">
                                <x-slot:icon>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                                </x-slot:icon>
                                Dashboard
                            ...
                            <x-web::dashboard-menu-component hash="#zmena-osobnich-udaju">
                                <x-slot:icon>
                            ...
                            <x-web::dashboard-menu-component hash="#zmena-hesla">
                                <x-slot:icon>
                            ...
                            <x-web::dashboard-menu-component hash="#rezervace">
                                <x-slot:icon>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                                </x-slot:icon>
                                Přehled rezervací
                            ...
                            <x-web::dashboard-menu-component hash="#kuzelkarska-liga">
                                <x-slot:icon>
    ...
    <div class="py-10 p-10 mx-auto">
        <div x-show="currentUrl === '#' || currentUrl.length === 0 " class="px-4 sm:px-6 lg:px-8">
            {{ $slot }}
        </div>

        <div class="mx-auto w-96 " x-show="currentUrl === '#zmena-osobnich-udaju'">
            <form class="space-y-3" method="POST" action="{{ route('update-information') }}">
                @csrf
