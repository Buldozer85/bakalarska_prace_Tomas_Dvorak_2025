<div class="flex items-start gap-2.5 w-full @if($isAdmin) justify-end @else justify-start @endif">
    {{ $slot }}
    <div class="flex flex-col w-[520px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl">
