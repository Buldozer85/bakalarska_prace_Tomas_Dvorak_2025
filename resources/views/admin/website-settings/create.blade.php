<x-admin.layouts.app title="Vytvoření nastavení" page="website-settings">
    <div class="shadow-lg rounded-md p-12 space-y-12 max-w-[1400px] mx-auto">
        ...
        <form class="space-y-4" method="POST" action="{{ route('administration.websiteSetting.create') }}">
            @csrf
            <div class="grid grid-cols-2 gap-4 gap-x-8 pb-12">
                <x-admin.form.input id="key" name="key" label="Klíč"/>
                <x-admin.form.input id="value" name="value" label="Hodnota"/>
            </div>
