...
class CreateUserRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'role' => ['required', Rule::in([Roles::USER->value, Roles::ADMINISTRATOR->value])],
            'phone' => ['required', 'string', 'max:255'],
            'email_verified_at' => ['boolean', 'required'],
    ...
    public function messages(): array
    {
        return [
            ...
            'email_verified_at.boolean' => 'Ověřený e-mail musí být Ano nebo Ne',
            'email_verified_at.required' => 'Ověření e-mailu je povinné',
